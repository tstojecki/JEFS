...
function AddJEFSCSS() {
    ...
    if (_spPageContextInfo.webServerRelativeUrl == "/") {
        ...
        fileref.setAttribute("href", _spPageContextInfo.webServerRelativeUrl + "/JEFS/Scripts/codemirror/codemirror.css");
    ...
    if (_spPageContextInfo.webServerRelativeUrl == "/") {
        ...
        fileref1.setAttribute("href", _spPageContextInfo.webServerRelativeUrl + "/JEFS/Scripts/codemirror/theme/night.css");
    }
...
JEFS.editor = (function (window, document, undefined) {
    ...
    function initEditor() {
        ...
        dlgDiv.innerHTML = '<form>' +
                            '<textarea id="jefs_editor"></textarea>' +
                            '<textarea id="jefs_includes"></textarea>' +
                            '<div style="float:left;width:150px;margin-top: 15px;font-size:10px;color:#000;margin-right:15px;">' +
                            '<input type="checkbox" id="jefs_wrap" /> wrap lines <br />' +
                            '<input type="checkbox" id="jefs_reload" checked="checked" /> reload after save</div>' +
                            '<div style="text-align:right;margin-top:5px; width:300px;float:right;font-size: 11px;">' +
                                'include:' +
                            '<select id="jefs_libs_select">' +
                            '<option value="none">None</option>' +
                            '</select>' +
                            '<a id="jefs_head" href="javascript:void(0);" style="margin:0 10px 0 5px;">show html</a>' +
                            '<button type="button" id="jefs_save" style="border: solid 1px #c3c3c3;background-color:#f1f1f1;padding: 3px;width: 85px;margin-right:8px;margin-top:15px;color: #21374C;font-size:11px;font-weight: bold;font-family: verdana;">save</button>' +
                            '</div>' +
        ...
        //This function is used to fetch the library names into the dropdown.
        getLibraries();
    }
    ...
    function getLibraries() {
        ...
        if (_spPageContextInfo.webServerRelativeUrl == "/") {
            ...
            loc = _spPageContextInfo.webServerRelativeUrl + '/lists/JEFS/libraries.txt';
        }
    ...
    return {
        ...
        launch: function () {
            ...
            //Since the fetching of the scripts is done asynchronusly, we need to run the init function just before we launch the dialog.
            initEditor();
